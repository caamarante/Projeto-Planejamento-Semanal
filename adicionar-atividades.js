...
botao_atividade.onclick = function adicionarAtividade() {
    ...
    console.log(guardarAtividadeHora);
        ...
        for (i=0; i < guardarHora.length; i++) {
            document.getElementById("cards__horarios-lista").insertAdjacentHTML("beforeend", '<li class="cards__horarios-item">' + guardarHora[i] + '</li>');
            ...
            for (j=0; j < guardarAtividadeHora[0].length; j++) {
                if (guardarHora[i] == guardarAtividadeHora[1][j]){
                    ...
                    document.getElementById(guardarHora[i]).insertAdjacentHTML("beforeend",'<li class="cards__atividades-item"><div class="cards__atividades-item-tag"></div><p class="cards__atividades-item-texto">' + guardarAtividadeHora[0][j] + '</p><buttton class="cards__atividades-item-apagar">Apagar</buttton></li>');
                }
            }
        }
